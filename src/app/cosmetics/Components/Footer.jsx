        ...
        <div className="oh-foot__container">
          ...
          <div className="oh-foot__brand">
            ...
            <p className="oh-foot__tag">
             Natural personal care products inspired by purity, wellness, and tradition
            </p>
          ...
          <div className="oh-foot__col">
            ...
            <ul className="oh-foot__list">
              ...
              <li><a href="/cosmetics/contact" onClick={(e) => { e.preventDefault(); router.push("/cosmetics/contact"); }}>Contact</a></li>
            </ul>
          </div>
          ...
          <div className="oh-foot__col">
            ...
            <ul className="oh-foot__list oh-foot__list--touch">
              <li className='icon'>
                <LocationIcon />
                <span>Vaiyam Naturals <br />
                 Chengalpattu - 603001.</span>
              </li>
              <li>
                <PhoneIcon />
                <span>Mobile    :+91  8939665002</span>
              </li>
              <li>
                <MailIcon />
                <span>vaiyamnaturals@gmail.com</span>
              </li>
            </ul>
          </div>
